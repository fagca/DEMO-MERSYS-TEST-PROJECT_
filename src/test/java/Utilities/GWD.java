...
public class GWD {
    ...
    // threadDriver.get() => ilgili thread deki driverı verecek
    // threadDriver.set() => ilgili thread'e driver set ediliyor
    ...
    public static WebDriver getDriver()
    {
        ...
        if (threadBrowserName.get() == null) // paralel çalışmayan xml den paratmetreyle gelmeyen geri çağıran
    ...
    public static void quitDriver()
    {
        ...
        if (threadDriver.get() != null) { // driver varsa
            ...
            driver=null;
            threadDriver.set(driver); // tekrar gelirse içi boş null olmuş olsun
